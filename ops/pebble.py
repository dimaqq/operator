...
class Client:
    ...
    def _checks_action(self, action: str, checks: Iterable[str]) -> List[str]:
        ...
        # FIXME this is fine if all pebble methods are explicitly instrumented:
        # ops.main (root span)
        #   charm.on_something (optional own span)
        #     pebble.start_checks (our span here)
        #       pebble._checks_action (sets "checks" attribute)
        #
        # This will look weird if we don't...
        # ops.main(checks=...)?
        # charm.on_something(checks=...)?
